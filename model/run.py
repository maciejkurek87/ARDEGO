...
class Run(object):
    ...
    def get_configuration_run_name(self):
        if self.configuration.trials_type  == "P_ARDEGO_Trial":
            return "tT_" + "AARDEGO" + "_corr_" + self.configuration.corr + "_nsims_" + str(self.configuration.n_sims) + "_parall_" + str(self.configuration.parall)
