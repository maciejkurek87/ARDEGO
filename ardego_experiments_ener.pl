...
$results_folder = "/data/mk306/ardego_quad_software_latin_lambdaLimit_${limit_lambda_search}_${n_sims}_${weights_on}_${sampling_fancy}_${fixMax4Bug}_${platformMax3}";
