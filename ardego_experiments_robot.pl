...
$results_folder = "/data/mk306/join/ardego_robot_f3_20_small_samples_software_latin_lambda_${limit_lambda_search}_${n_sims}_${weights_on}_${sampling_fancy}";
...
chomp($epoch);
$tempfile = "/data/mk306/temp_ardego_robot_$epoch.txt";
