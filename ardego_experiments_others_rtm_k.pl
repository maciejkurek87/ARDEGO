...
#$results_folder = "/data/mk306/join/ardeg_xinyu_max3_use_maia_lambda_${limit_lambda_search}_${n_sims}_${weights_on}_${sampling_fancy}";
$results_folder = "/data/mk306/join/ardeg_xinyu_maia_use_max3_RESOURCE_4_lambda_${limit_lambda_search}_${n_sims}_${weights_on}_${sampling_fancy}";
...
chomp($epoch);
$tempfile = "/data/mk306/temp_ardego_rtm_knowRESIYRCE_$epoch.txt";
...
#    modify($max_error_tag, $_, $fitness_file);
    ...
    foreach (@p) {
        if ($j % $parallelism == ($i - 1)){ #easiest way to divide tasks
            ...
            $old_run_dir = 'old_run_dir = "/data/mk306/ardego_maiaUsingMax3_xinyu_rtm_software_latin_lambda_False_5000_True_True/tT_AARDEGO_corr_anisotropic_nsims_5000_parall_1_fF_rtm/"';
            #$old_run_dir = 'old_run_dir = "/data/mk306/ardeg_xinyu_puremaia_lambda_False_5000_True_True/tT_AARDEGO_corr_anisotropic_nsims_5000_parall_2_fF_rtm/"';
