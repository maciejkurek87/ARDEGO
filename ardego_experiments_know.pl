...
$results_folder = "/data/mk306/join/ardego_quad_maia_8_23_4_fit_added_knowledge_software_latin_lambdaLimit_${limit_lambda_search}_${n_sims}_${weights_on}_${sampling_fancy}_${fixMax4Bug}_${platformMax3}";
...
chomp($epoch);
$tempfile = "/data/mk306/temp_ardeg_quad_new_know3_$epoch.txt";
    ...
    foreach (@maxError) {
        ...
        foreach (@p) {
            if ($j % $parallelism == ($i - 1)){ #easiest way to divide tasks
                ...
                $old_run_dir = 'old_run_dir = "/data/mk306/old/ardego_quad_software_latin_lambdaLimit_False_5000_True_True_False_True/tT_AARDEGO_corr_anisotropic_nsims_5000_parall_2_fF_ansonE'.$errorr.'ThTrue/"';
