            ...
            try:
                ...
                for i in range(D_0):
                    for j in range(D_1):
                        ...
                        def forceAspect(ax, extent, aspect=1):
                        ...
                        if meta_plots: ## OLD METAPLOTS
                            ...
                            for value in meta_plots[i*D_1 + j]:
                                ...
                                #forceAspect(grid[i*D_1 + j], [d['X'].min(), d['X'].max(), d['Y'].min(), d['Y'].max()])
                        else:
                            if lognorm:
                ...
                grid[4].set_xlabel("Cores", fontsize = 26)
                ...
                if True:
                    for ax in grid.axes_all: 
                        ...
                        ax.tick_params(direction='out', labelsize='22',which='major', length=1) 
                        for xlabel in ax.get_xticklabels():
                            xlabel.set_rotation(-90)
                        #ax.xaxis.get_minor_ticks()[0].set_visible(False)
                        #ax.yaxis.get_minor_ticks()[0].set_visible(False)
                if False:
                    for ax in grid.axes_all:
